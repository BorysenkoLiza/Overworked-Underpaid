...
public class MonthView implements View {
    ...
    private int days;
    private Slot[] slots;
//    private LocalDate current; // holds the day that is currently viewed (in case next/default/previous will be added in facade too)
    ...
    public void displayView() {
        System.out.println("Monthly com.calendar.view.View");
    }
    @Override
    public void reset() {
        DefaultView(1,1);
