...
public class Slot {
    ...
    public Slot(LocalDate d, int w, int l){
        ...
        todayEvents=com.company.calender.eventCategory.CriteriaCategory.dateCriteria(com.company.calender.eventType.Event.getArrayList(),d);//to add array of events for this date
    }
